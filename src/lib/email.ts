    ...
    .map(
      ...
      <div style="background:#FFFFFF;border:1px solid #E5E8ED;border-radius:8px;overflow:hidden;margin-bottom:12px;">
        ...
        <div style="margin-top:12px;">
          ...
          <a href="https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent(esc(r.title).split(" ").slice(0, 10).join(" "))}&LH_Complete=1&LH_Sold=1&_sop=12&rt=nc&LH_ItemCondition=4" style="display:inline-block;background:#FFFFFF;color:#0B1D3A;padding:8px 20px;border-radius:6px;font-size:12px;font-weight:700;text-decoration:none;border:2px solid #D4A847;margin-left:8px;">Price Check &rarr;</a>
        </div>
        </div>
      </div>`
    )
